...
public class ManyColumnsTsvParserTest {
    ...
    public void advancedTsvParserTest() throws IOException {
        for (String tsvPattern : Arrays.asList("LRLL", "RRRR", "LLLL", "LLRRLL", "RRLLRR",
                        "LRLRLRLR", "RRRLLRLRL", "RRLLLLLRR", "LLRRRRRL", "LERL", "EERL", "LEER",
                        "ELLRELEE", "ELEE", "EEE")) {
     ...
     * <p>
     * 
     * <b>Example</b> <code>RLRLL</code> ... creates a TSV with a resource, literal, resource,
     * literal, literal
     */
        ...
        for (char ch : tsvPattern.toCharArray()) {
            switch (ch) {
                ...
                case 'L':
                    ...
                    break;
                case 'E':
                    header.add("?e" + counter);
                    row.add("");
                    // add no tuple to the result, since empty tuples do not produce results.
                    break;
            }
            counter++;
        }
