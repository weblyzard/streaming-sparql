 ...
 * the SPARQL server..
 *
 * This client has been developed to test the performance of SPARQL queries by
 * retrieving data on resources specified in an entity file from a linked data
 * repository.
 * 
